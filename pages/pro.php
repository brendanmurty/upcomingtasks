...
<h2><?= $app_name ?> Pro</h2>
<p>For a small monthly cost, a <?= $app_name ?> Pro account gives access to additional features, including:</p>
...
<p><?= $app_name ?> was created as a side-project in September 2012 by <a href="http://brendan.murty.id.au/">Brendan Murty</a>. Along with access to additional features, paying for a <?= $app_name ?> Pro account helps support future development and pay for ongoing maintenance costs.</p>
